<div class="modal fade" id="editProjectModal" tabindex="-1" aria-labelledby="exampleModalPopoversLabel" aria-modal="true">
    <div class="modal-dialog ">
        <div class="modal-content">
            ...
            <form id="editProjectForm" action="<?php echo e(route('admin.projects.update')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <div class="modal-body row g-3">
                    <input type="hidden" name="project_id" id="project_id">
                    <div class="col-md-12">
                        <label for="validationDefault01" class="form-label">Name<?php if (isset($component)) { $__componentOriginal27abc86fb91a36b7c85cb140e4c313c7 = $component; } ?>
...
unset($__errorArgs, $__bag); ?></span>
                    ...
                    <div class="col-md-12">
                        <label for="validationDefault" class="form-label">Description<?php if (isset($component)) { $__componentOriginal27abc86fb91a36b7c85cb140e4c313c7 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal27abc86fb91a36b7c85cb140e4c313c7 = $attributes; } ?>
<?php $component = App\View\Components\RequiredStar::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('required-star'); ?>
<?php if ($component->shouldRender()): ?>
...
<?php /**PATH /var/www/fastuser/data/www/crm.kulvriksh.in/resources/views/admin/projects/edit.blade.php ENDPATH**/ ?>