<?php $__env->startSection('pagetitle', 'Add Lead | Kulvriksh'); ?>
<?php $__env->startSection('admin-content'); ?>
    ...
    <form action="<?php echo e(url('admin/leads/store')); ?>" method="post" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
            ...
            <div class="col-xl-12">
                <div class="card form-box">
                    ...
                    <div class="card-footer d-flex justify-content-between">
                        <a href="<?php echo e(url('admin/leads')); ?>" type="button" id="notes" class="btn btn-secondary">Cancel</a>
                        <button type="submit" id="notes" class="btn btn-primary"> Save</button>
                    </div>
                </div><!-- end card -->
            </div>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/fastuser/data/www/crm.kulvriksh.in/resources/views/admin/leads/add.blade.php ENDPATH**/ ?>