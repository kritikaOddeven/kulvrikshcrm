...
<html lang="en">
    <head>
        ...
        <meta charset="utf-8" />
        <title>Error 404 | Kulvriksh - </title>
                            ...
                            <div class="col-md-5 mx-auto">
                                <div class="text-center">
                                    ...
                                    <div class="error-page mt-4">
                                        <img src="<?php echo e(asset('assets/admin/images/svg/404-error.svg')); ?>" class="img-fluid" alt="coming-soon">
                                    </div>
...
</html><?php /**PATH /var/www/fastuser/data/www/crm.kulvriksh.in/resources/views/errors/404.blade.php ENDPATH**/ ?>