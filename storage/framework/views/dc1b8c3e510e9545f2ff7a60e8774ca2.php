<div class="accordion-item">
                                ...
                                <div class="accordion-body">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3 col-md-6 mb-2">
                                            ...
                                            <input type="text" class="form-control" id="primary_clan" name="primary_clan[]">
                                        </div>
                                        ...
                                        <div class="col-lg-3 col-md-6 mb-2">
                                            ...
                                            <input type="text" class="form-control" id="spiritual_seat" name="spiritual_seat[]">
                                        </div>

                                        <div class="col-md-12 mb-2">
                                            <label for="ancestral_village" class="form-label">Ancestral Village</label>
                                            <input type="text" class="form-control" id="ancestral_village" name="ancestral_village[]" maxlength="255">
                                        </div>
                        ...
                        </div><?php /**PATH /var/www/fastuser/data/www/crm.kulvriksh.in/resources/views/admin/leads/partials/lineage/lead-lineage.blade.php ENDPATH**/ ?>