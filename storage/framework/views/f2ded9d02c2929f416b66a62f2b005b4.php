<div class="modal fade" id="expense" tabindex="-1" aria-labelledby="exampleModalPopoversLabel" aria-modal="true">
    <div class="modal-dialog ">
        <div class="modal-content">
            ...
            <form id="addExpenseForm" action="<?php echo e(route('admin.expenses.category.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <div class="modal-body row g-3">
                    <div class="col-md-6">
                        <label for="validationDefault01" class="form-label">Category<?php if (isset($component)) { $__componentOriginal27abc86fb91a36b7c85cb140e4c313c7 = $component; } ?>
...
<div class="modal fade" id="editCatExpense" tabindex="-1" aria-labelledby="exampleModalPopoversLabel" aria-modal="true">
    <div class="modal-dialog ">
        <div class="modal-content">
            ...
            <form id="editExpenseForm" action="<?php echo e(route('admin.expenses.category.update')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <div class="modal-body row g-3">
...
<?php /**PATH /var/www/fastuser/data/www/crm.kulvriksh.in/resources/views/admin/expense/category/add-edit.blade.php ENDPATH**/ ?>