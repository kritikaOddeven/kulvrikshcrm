...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('campaignForm').addEventListener('submit', function(e) {
        ...
        fetch('<?php echo e(route("admin.whatsapp.campaign.store")); ?>', {
            method: 'POST',
            headers: {
...
</script> <?php /**PATH /var/www/fastuser/data/www/crm.kulvriksh.in/resources/views/admin/whatsapp/campaign/send-campaign-modal.blade.php ENDPATH**/ ?>