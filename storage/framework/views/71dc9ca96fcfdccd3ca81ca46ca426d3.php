        ...
        <div class="accordion-body">
            <div class="row">
                <div class="col-lg-3 col-md-6 mb-2">
                    <label for="validationDefault01" class="form-label">First Name<?php if (isset($component)) { $__componentOriginal27abc86fb91a36b7c85cb140e4c313c7 = $component; } ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-lg-3 col-md-6 mb-2">
                    <label for="validationDefault01" class="form-label">Last Name<?php if (isset($component)) { $__componentOriginal27abc86fb91a36b7c85cb140e4c313c7 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal27abc86fb91a36b7c85cb140e4c313c7 = $attributes; } ?>
<?php $component = App\View\Components\RequiredStar::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('required-star'); ?>
<?php if ($component->shouldRender()): ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-lg-3 col-md-6 mb-2">
                    ...
                    <div class="position-relative">
                        <input type="text" value="<?php echo e(old('dob')); ?>" class="form-control basic-datepicker pe-5" name="dob" id="dob" placeholder="dd-mm-yyyy">
                ...
                <div class="col-lg-3 col-md-6 mb-2">
                    ...
                    <div class="position-relative">
                        <input type="text" class="form-control basic-datepicker pe-5" value="<?php echo e(old('marriage_date')); ?>" name="marriage_date" id="marriage_date" placeholder="dd-mm-yyyy">
                        <i class="ri-calendar-2-line calendar-icon"></i>
                    </div>
                </div>

                <div class="col-lg-3 col-md-6 mb-2">
                    <label for="validationDefault01" class="form-label">Phone No. <?php if (isset($component)) { $__componentOriginal27abc86fb91a36b7c85cb140e4c313c7 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal27abc86fb91a36b7c85cb140e4c313c7 = $attributes; } ?>
<?php $component = App\View\Components\RequiredStar::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('required-star'); ?>
<?php if ($component->shouldRender()): ?>
...
<?php endif; ?></label>
                    <div class="input-group">
                        <input type="hidden" name="phonecode" value="<?php echo e(old('phonecode') ?? '+91'); ?>">
                        <span class="input-group-text" id="phonecode">+91</span>
                        <input type="text" class="form-control" value="<?php echo e(old('phone')); ?>" name="phone" maxlength="10" oninput="this.value = this.value.replace(/[^0-9]/g, '')">
                    </div>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-lg-3 col-md-6 mb-2">
                    ...
                    <div class="input-group">
                        <input type="hidden" name="alternate_phonecode" value="<?php echo e(old('alternate_phonecode') ?? '+91'); ?>">
                        <span class="input-group-text" id="alternate_phonecode">+91</span>
                        <input type="text" class="form-control" value="<?php echo e(old('alternate_mobile_number')); ?>" name="alternate_mobile_number" maxlength="10" oninput="this.value = this.value.replace(/[^0-9]/g, '')">
                    </div>
                    <span class="text-danger">
                        <?php $__errorArgs = ['alternate_mobile_number'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-lg-3 col-md-6 mb-2">
                    <label for="validationDefault01" class="form-label">Country<?php if (isset($component)) { $__componentOriginal27abc86fb91a36b7c85cb140e4c313c7 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal27abc86fb91a36b7c85cb140e4c313c7 = $attributes; } ?>
<?php $component = App\View\Components\RequiredStar::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('required-star'); ?>
<?php if ($component->shouldRender()): ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-lg-3 col-md-6 mb-2">
                    <label for="validationDefault01" class="form-label">State<?php if (isset($component)) { $__componentOriginal27abc86fb91a36b7c85cb140e4c313c7 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal27abc86fb91a36b7c85cb140e4c313c7 = $attributes; } ?>
<?php $component = App\View\Components\RequiredStar::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('required-star'); ?>
<?php if ($component->shouldRender()): ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-lg-3 col-md-6 mb-2">
                    <label for="validationDefault01" class="form-label">District<?php if (isset($component)) { $__componentOriginal27abc86fb91a36b7c85cb140e4c313c7 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal27abc86fb91a36b7c85cb140e4c313c7 = $attributes; } ?>
<?php $component = App\View\Components\RequiredStar::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('required-star'); ?>
<?php if ($component->shouldRender()): ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-lg-6 col-md-4">
                    ...
                    <input type="text" class="form-control" value="<?php echo e(old('notes_address')); ?>" name="notes_address">
                </div>
...
<?php /**PATH /var/www/fastuser/data/www/crm.kulvriksh.in/resources/views/admin/leads/partials/lead-info.blade.php ENDPATH**/ ?>