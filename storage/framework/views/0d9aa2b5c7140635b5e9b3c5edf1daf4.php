<div class="modal fade" id="subproject" tabindex="-1" aria-labelledby="exampleModalPopoversLabel" aria-modal="true">
    <div class="modal-dialog ">
        <div class="modal-content">
            ...
            <form id="subProjectAddForm" action="<?php echo e(route('admin.projects.subproject.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <div class="modal-body row g-3">
                    <div class="col-md-12">
                        <label for="validationDefault04" class="form-label">Category<?php if (isset($component)) { $__componentOriginal27abc86fb91a36b7c85cb140e4c313c7 = $component; } ?>
...
<?php endif; ?></label>
                        <input type="text" class="form-control" disabled value="<?php echo e($project->name); ?>">
                        <input type="hidden" class="form-control"  value="<?php echo e($project->id); ?>" name="project_id">
                        <span class="text-danger"><?php $__errorArgs = ['project_id'];
...
<?php unset($__componentOriginal27abc86fb91a36b7c85cb140e4c313c7); ?>
<?php endif; ?></label>
                        <input type="text" class="form-control" maxlength="255" id="validationDefault01" value="<?php echo e(old('name')); ?>" name="name">
...
<?php unset($__componentOriginal27abc86fb91a36b7c85cb140e4c313c7); ?>
<?php endif; ?></label>
                        <input type="number" class="form-control" id="validationDefault01" value="<?php echo e(old('amount')); ?>" name="amount" step="0.01">
...
<div class="modal fade" id="editSubProject" tabindex="-1" aria-labelledby="exampleModalPopoversLabel" aria-modal="true">
    <div class="modal-dialog ">
        <div class="modal-content">
            ...
            <form id="subProjectEditForm" action="<?php echo e(route('admin.projects.subproject.update')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<script>
    ...
    $('.editbtn').on('click', function() {
        ...
        $.ajax({
            url: "<?php echo e(url('admin/projects/subproject/edit/')); ?>" + '/' + subProject_id,
            type: 'GET',
            success: function(response) {
...
<?php /**PATH /var/www/fastuser/data/www/crm.kulvriksh.in/resources/views/admin/projects/subAddEditProject.blade.php ENDPATH**/ ?>