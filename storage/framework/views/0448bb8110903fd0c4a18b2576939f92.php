<div class="modal fade" id="addExpense" tabindex="-1" aria-labelledby="exampleModalPopoversLabel" aria-modal="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form id="addExpenseForm" action="<?php echo e(route('admin.expenses.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <div class="modal-body row g-3">
                    <div class="col-md-6">
                        <label for="validationDefault01" class="form-label">Title <?php if (isset($component)) { $__componentOriginal27abc86fb91a36b7c85cb140e4c313c7 = $component; } ?>
...
<?php unset($__componentOriginal27abc86fb91a36b7c85cb140e4c313c7); ?>
<?php endif; ?></label>
                        <input type="number" class="form-control" value="<?php echo e(old('amount')); ?>" name="amount">
                        <span class="text-danger">
...
<?php endif; ?></label>
                        ...
                        <div class="position-relative">
                            <input type="text" class="form-control basic-datepicker" value="<?php echo e(old('date')); ?>" name="date" placeholder="dd-mm-yyyy">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-select" id="validationDefault04" name="status">
                            ...
                            <option value="active" <?php echo e(old('status') == 'inactive' ? 'selected' : ''); ?>>Inactive</option>
                        </select>
                    </div>
...
<?php /**PATH /var/www/fastuser/data/www/crm.kulvriksh.in/resources/views/admin/expense/add.blade.php ENDPATH**/ ?>