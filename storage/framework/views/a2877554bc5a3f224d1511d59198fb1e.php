<?php $__env->startSection('pagetitle', 'Import/Export Data | Lead Management'); ?>
                ...
                <div class="row mb-4">
                    <div class="col-12">
                        <div class="border rounded p-4">
                            ...
                            <form action="<?php echo e(route('admin.settings.import.upload')); ?>" method="POST" enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                ...
                <div class="row mb-4">
                    <div class="col-12">
                        <div class="border rounded p-4 bg-success bg-opacity-10">
                            ...
                            <form action="<?php echo e(route('admin.settings.import.export.data')); ?>" method="POST" id="exportForm">
                                <?php echo csrf_field(); ?>
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="mb-3">
                        ...
                        <div class="border rounded p-3 bg-light">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <a href="<?php echo e(route('admin.settings.import.template', 'countries')); ?>" class="btn btn-primary btn-sm">
                        ...
                        <div class="border rounded p-3 bg-light">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <a href="<?php echo e(route('admin.settings.import.template', 'states')); ?>" class="btn btn-primary btn-sm">
                                        <i class="ri-download-line me-1"></i>Download Template
                                    </a>
                                </div>
                                <div class="col-md-6">
                        ...
                        <div class="border rounded p-3 bg-light">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <a href="<?php echo e(route('admin.settings.import.template', 'cities')); ?>" class="btn btn-primary btn-sm">
                                        <i class="ri-download-line me-1"></i>Download Template
                                    </a>
                                </div>
                                <div class="col-md-6">
                        ...
                        <div class="border rounded p-3 bg-light">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <h6 class="text-muted">Step 1: Download Template</h6>
                                    <p class="text-muted small mb-3">Download the CSV template and fill it with your data. State ID should be numerical.</p>
                                    <a href="<?php echo e(route('admin.settings.import.template', 'districts')); ?>" class="btn btn-primary btn-sm">
                                        <i class="ri-download-line me-1"></i>Download Template
                                    </a>
                                </div>
                                <div class="col-md-6">
                        ...
                        <div class="border rounded p-3 bg-light">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <a href="<?php echo e(route('admin.settings.import.template', 'talukas')); ?>" class="btn btn-primary btn-sm">
                                        <i class="ri-download-line me-1"></i>Download Template
                                    </a>
                                </div>
                                <div class="col-md-6">
                        ...
                        <div class="border rounded p-3 bg-light">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <a href="<?php echo e(route('admin.settings.import.template', 'villages')); ?>" class="btn btn-primary btn-sm">
                                        <i class="ri-download-line me-1"></i>Download Template
                                    </a>
                                </div>
                                <div class="col-md-6">
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/fastuser/data/www/crm.kulvriksh.in/resources/views/admin/settings/import/index.blade.php ENDPATH**/ ?>