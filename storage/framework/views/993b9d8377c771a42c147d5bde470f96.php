<?php $__env->startSection('pagetitle', 'Researcher Report | Kulvriksh'); ?>
<?php $__env->startSection('admin-content'); ?>
                                ...
                                <tr>
                                    ...
                                    <td style="width: 150px">
                                        <div class="d-flex gap-2">
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('download_researcher_report')): ?>
                                                <?php if($report->report && $report->report->exists()): ?>
                                                    <button type="button" class="btn-sm edit-icon-btn" onclick="downloadPDF(<?php echo e($report->id); ?>)" title="Download"><i class="ri-download-2-line"></i></button>
                                                <?php endif; ?>
                                            <?php endif; ?>
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view_researcher_report')): ?>
                                            ...
                                            <?php endif; ?>
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete_researcher_report')): ?>
                                                <form action="<?php echo e(url('admin/research-reports/delete/' . $report->id)); ?>" method="POST" id="deleteForm_<?php echo e($report->id); ?>" style="display:inline;">
                                                    <?php echo csrf_field(); ?>
    ...
    <script>
        function downloadPDF(reportId) {
            ...
            fetch(`<?php echo e(url('admin/research-reports/pdf1')); ?>/${reportId}`)
                .then(response => {
                    if (!response.ok) {
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/fastuser/data/www/crm.kulvriksh.in/resources/views/admin/researchers/reports/index.blade.php ENDPATH**/ ?>