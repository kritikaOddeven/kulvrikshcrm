<?php $__env->startSection('pagetitle', 'View Researcher | Kulvriksh'); ?>
    ...
    <div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
        <div class="flex-grow-1">
            ...
            <ol class="breadcrumb m-0 py-0">
                ...
                <li class="breadcrumb-item active"><a href="<?php echo e(url('admin/researcher')); ?>">View All Researcher</a></li>
...
<?php endif; ?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="tab-content p-3 text-muted">
                                        <div class="tab-pane active" id="conversation" role="tabpanel">
                                            ...
                                            <div class="row">
                                                ...
                                                <?php $__currentLoopData = $data->conversation; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    ...
                                                    ?>
                                                    <input type="hidden" name="added_by[]" value="<?php echo e($item->added_by); ?>">

                                                    <div class="col-md-12 mb-2" data-note-id="<?php echo e($item->id); ?>">
                                                        <div class="d-flex justify-content-between mb-1">
                                                            <label class="d-flex align-items-center mb-2 form-label">
                                                                <img src="<?php echo e(asset(get_profile_image($item->user->profile_image, $item->user->name))); ?>" class="avatar avatar-sm rounded-circle me-2">
                                                                <?php echo e($item->user->name ?? ''); ?>
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                <span class="text-end me-2"><?php echo e($item->created_at->format('D d F, g:i')); ?></span>
                                                                <?php if($item->added_by == auth()->id() || auth()->user()->hasRole('super-admin')): ?>
                                                                    <button type="button" class="btn btn-sm btn-outline-primary edit-researcher-note-btn" data-note-id="<?php echo e($item->id); ?>">
                                                            ...
                                                            <?php if($item->attachment): ?>
                                                                <div class="file-item d-flex align-items-center gap-2 mt-2">
                                                                    <div class="attachment-item">
                                                                        <a href="<?php echo e(asset($item->attachment)); ?>" target="_blank" class="text-decoration-none">
                                                        ...
                                                        <div class="researcher-note-edit-mode" style="display: none;">
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <textarea class="form-control original-content-edit" style="min-height: 150px;"><?php echo e($item->original_content ?? $item->content); ?></textarea>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <label class="form-label"><strong>Translated Content</strong></label>
                                                                    <textarea class="form-control translated-content-edit" style="min-height: 150px;"><?php echo e($item->content); ?></textarea>
                                                                </div>
                                                            </div>
                                                            <div class="row mt-2">
                                                                <div class="col-md-12">
                                                                    <button type="button" class="btn btn-success save-researcher-note-btn" data-note-id="<?php echo e($item->id); ?>">
                                        ...
                                        <div class="tab-pane" id="researcherview" role="tabpanel">
                                            ...
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            <!-- Language Selection -->
                                            <?php if(!($data->researcherView->count() > 0)): ?>
                                                <form action="<?php echo e(url('admin/researcher/store-view/')); ?>" method="post">
                                                    <?php echo csrf_field(); ?>
                                                    <div class="row mb-3">
                                                        <input type="hidden" name="type" id="viewType" value="view">
                                                        <input type="hidden" name="clientId" id="clientId" value="<?php echo e($data->id); ?>">
                                            ...
                                            <div class="text-center">
                                                <a href="<?php echo e(url('admin/researcher/create-report/' . $data->id)); ?>" value="true" class="btn btn-success">Create Researcher Report</a>
                                            </div>
                                        </div>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            const clientId = <?php echo e($data->id); ?>;
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/fastuser/data/www/crm.kulvriksh.in/resources/views/admin/researchers/view.blade.php ENDPATH**/ ?>