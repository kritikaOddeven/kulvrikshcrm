        ...
        <div class="modal-content">
            <div class="modal-header d-flex justify-content-between">
                ...
                <div class="">
                    ...
                    REF00 <span id="convert_to_lead_id2"><?php echo e(request()->id ?? ''); ?></span>
                </strong>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
               
            </div>
            <form id="convertLeadForm" action="<?php echo e(url('admin/leads/convert-to-client')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <input type="hidden" name="lead_id" id="convert_to_lead_id" value="<?php echo e(request()->id ?? ''); ?>">
...
<script>
    $(document).ready(function() {
        ...
        $('#addMore').click(function(e) {
            ...
            const projectOptions = <?php echo json_encode($projects, 15, 512) ?>.map(
...
<?php /**PATH /var/www/fastuser/data/www/crm.kulvriksh.in/resources/views/admin/leads/modals/lead-to-client-modal.blade.php ENDPATH**/ ?>