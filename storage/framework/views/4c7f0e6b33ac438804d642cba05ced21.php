    ...
    <div class="header">
        <table style="width: 100%;">
            <tr>
                <td style="width: 50%;">
                    <div class="logo">
                        <img src="<?php echo e(asset('assets/admin/images/logo.png')); ?>" alt="Kulvriksh Logo" style="max-width: 150px; max-height: 60px;">
                    </div>
                </td>
                <td style="width: 50%;">
                    <div class="invoice-number">
                        Invoice #<?php echo e($bill->invoice_number); ?>
            ...
            <tr>
                <td style="width: 25%;">
                    <div class="info-item">
                        ...
                        <div class="info-value"><?php echo e($bill->client->kulvrisk_id ?? '-'); ?></div>
                    </div>
                </td>
                <td style="width: 25%;">
                    <div class="info-item">
                        <div class="info-label">Created On</div>
                        <div class="info-value"><?php echo e($bill->created_at->format('d M Y')); ?></div>
                    </div>
                </td>
                <td style="width: 25%;">
                    <div class="info-item">
                ...
                <td style="width: 25%;">
                    <div class="info-item">
                        ...
                        <div class="info-value">₹<?php echo e(number_format((float) $totalAmount, 2, '.', ',')); ?></div>
                    </div>
                </td>
            </tr>
        </table>
        ...
        <tbody>
            <?php $__currentLoopData = $projects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $project): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    ...
                    <td><?php echo e($bill->sac_number); ?></td>
                    <td class="amount-value">₹<?php echo e(number_format((float) $project->amount, 2, '.', ',')); ?></td>
                </tr>
            ...
            <td style="width: 60%;">
                <div class="notes-section">
                    ...
                    <div class="bank-details bank-details-box">
                        ...
                        <p><span>Branch:</span> <?php echo e($bill->bankAccount->branch_name ?? 'N/A'); ?></p>
            ...
            <td style="width: 40%;">
                <div class="subtotal-box">
                    <div class="total-row">
                        ...
                        <span class="total-number">₹ <?php echo e(number_format((float) ($isIndia ? $subTotal : $subTotal + $cgst + $sgst), 2, '.', ',')); ?></span>
                    </div>
                    <?php if($isIndia): ?>
                        <?php if($isGujarat): ?>
                            <div class="total-row">
                                <span class="title pe-3">CGST <small class="text-danger">(9%)</small>:</span>
                                <span class="total-number">₹ <?php echo e(number_format((float) $cgst, 2, '.', ',')); ?></span>
                            </div>
                            <div class="total-row">
                                <span class="title pe-3">SGST <small class="text-danger">(9%)</small>:</span>
                                <span class="total-number">₹ <?php echo e(number_format((float) $sgst, 2, '.', ',')); ?></span>
                            </div>
                        <?php else: ?>
                            <div class="total-row">
                                <span class="title pe-3">IGST <small class="text-danger">(18%)</small>:</span>
                                <span class="total-number">₹ <?php echo e(number_format((float) $igst, 2, '.', ',')); ?></span>
                            </div>
                        <?php endif; ?>
                    <?php endif; ?>
                    <div class="total-row">
                        <span class="title pe-3">Actual Amount:</span>
                        <span class="total-number">₹ <?php echo e(number_format((float) $grossAmount, 2, '.', ',')); ?></span>
                    </div>
                    <?php if($roundOffDiscount > 0): ?>
                        <div class="total-row">
                            <span class="title pe-3">Round-off Discount:</span>
                            <span class="total-number">₹ <?php echo e(number_format((float) $roundOffDiscount, 2, '.', ',')); ?></span>
                        </div>
                    <?php endif; ?>
                    <div class="total-row">
                        <span class="total-title pe-3">Total Amount:</span>
                        <span class="total-title">₹ <?php echo e(number_format((float) $totalAmount, 2, '.', ',')); ?></span>
                    </div>
                </div>
...
<?php /**PATH /var/www/fastuser/data/www/crm.kulvriksh.in/resources/views/admin/bills/pdf.blade.php ENDPATH**/ ?>