                        ...
                        <tr>
                            <td align="left" valign="top" colspan="2" style="padding-top: 10px;">
                                <span style="font-size: 12px; line-height: 1.5; color: #333333;">
                                    Dear <?php echo e($agent->roles->pluck('name')->first()); ?>,
                                    <br /><br />
                                    ...
                                    <div style="text-align: left; margin-top: 20px;">
                                        <ul>
                                            ...
                                            <li><strong>Name:</strong> <?php echo e($agent->name); ?>,</li>
                                            <li><strong>Email Address:</strong> <?php echo e($agent->email); ?>,</li>
                                            <li><strong>Password:</strong> <?php echo e($plainPassword); ?></li>
                                        </ul>
                                    </div>
                                    <br /><br />
...
<?php /**PATH /var/www/fastuser/data/www/crm.kulvriksh.in/resources/views/emails/agent/welcome-email.blade.php ENDPATH**/ ?>