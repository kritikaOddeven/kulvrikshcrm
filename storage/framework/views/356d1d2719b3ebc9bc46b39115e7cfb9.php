...
<html lang="en">
    <head>
        ...
        <meta charset="utf-8" />
        <title>Error 405 | Kulvriksh - </title>
                        ...
                        <div class="row">
                            <div class="col-md-5 mx-auto">
                                <div class="text-center">
                                    <div class="mb-0">
                                        <h3 class="mt-4 fw-semibold text-dark text-capitalize">Method Not Allowed</h3>
                                        <p class="text-muted">The request method is not supported for this resource. <br> Please try a different approach or contact support.</p>
                                    </div>

                                    <a class='btn btn-primary mt-3 me-1' href='<?php echo e(url('admin/dashboard')); ?>'>Back to Dashboard</a>

                                    <div class="maintenance-img mt-4">
                                        <img src="<?php echo e(asset('assets/admin/images/svg/429-error.svg')); ?>" class="img-fluid" alt="method-not-allowed">
                                    </div>
...
</html> <?php /**PATH /var/www/fastuser/data/www/crm.kulvriksh.in/resources/views/errors/405.blade.php ENDPATH**/ ?>