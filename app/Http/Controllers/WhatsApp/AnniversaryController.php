...
class AnniversaryController extends Controller
{
    public function todayBirthdays(Request $request)
    {
        ...
        foreach ($leadBirthdays as $lead) {
            $birthdays->push([
                ...
                'email' => $lead->email,
                'phone' => $lead->phone,
                'phonecode' => $lead->phonecode ?? ($lead->countries->phonecode ?? ''),
        ...
        foreach ($familyBirthdays as $family) {
            $birthdays->push([
                ...
                'phonecode' => $family->lead->phonecode ?? ($family->lead->countries->phonecode ?? ''),
        ...
        return view('admin.whatsapp.birthday.today-birthday', compact('birthdays', 'countries', 'templates'));
    }
    ...
    //     $familyQuery->whereHas('lead', function($q) use ($request) {
    //         if ($request->has('country') && $request->country) {
    ...
    //     $familyBirthdays = $familyQuery->with(['lead.countries', 'lead.states', 'lead.cities'])->get();
    ...
    //     return view('admin.whatsapp.birthday.all-birthday', compact('birthdays', 'countries', 'templates'));
    // }
    ...
    public function todayMarriageAnniversaries(Request $request)
    {
        ...
        return view('admin.whatsapp.marriage.today-marriage', compact('anniversaries', 'countries', 'templates'));
    }
    ...
    //     $familyAnniversaries = $familyQuery->with(['lead.countries', 'lead.states', 'lead.cities'])->get();
    ...
    //     return view('admin.whatsapp.marriage.all-marriage', compact('anniversaries', 'countries', 'templates'));
    // }
    ...
    public function todayDeathAnniversaries(Request $request)
    {
        ...
        return view('admin.whatsapp.death.today-death', compact('anniversaries', 'countries', 'templates'));
    }
    ...
    //     return view('admin.whatsapp.death.all-death', compact('anniversaries', 'countries', 'templates'));
    // }
