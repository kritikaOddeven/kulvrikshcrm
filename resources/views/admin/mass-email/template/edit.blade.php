...
@section('admin-content')
    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="card">
                <form action="{{url('/admin/mass-email/template/update')}}" method="post">
                    @csrf
                    <div class="card-body mb-0">
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-2">
                                ...
                                <input type="text" class="form-control" name="subject" value=" {{$template->subject}}" placeholder="Enter Subject">
                                <span class="text-danger">
                                    @error('subject')
                                        {{ $message }}
                                    @enderror
                            ...
                            <div class="col-md-12 mb-2">
                                ...
                                <textarea name="description" id="editor" class="editor" placeholder="Description" >
