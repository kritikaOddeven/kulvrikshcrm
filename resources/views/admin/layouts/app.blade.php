...
<head>
    ...
    <meta charset="utf-8" />
    {{-- <title>Dashboard | Kulvriksh</title> --}}
...
<meta name="csrf-token" content="{{ csrf_token() }}">
    ...
    <link href="{{ asset('assets/admin/css/custom.css') }}" rel="stylesheet" type="text/css" id="app-style" />
...
<body data-menu-color="light" data-sidebar="default">
        ...
        <div class="content-page">
            <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    {{-- Remove it leter just for testing --}}
                    @if (app()->environment('local') && $errors->any())
                        ...
                        <div x-data="{ show: true }" x-init="setTimeout(() => show = false, 5000)" x-show="show" x-transition class="alert alert-danger alert-dismissible fade show mt-3" role="alert">
                            <strong>We couldn't save your submission due to issues with the following fields:</strong> {{ $fields }}.
    ...
    <script src="{{ asset('assets/admin/js/pages/form-picker.js') }}"></script>
