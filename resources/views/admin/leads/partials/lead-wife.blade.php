        ...
        <div class="accordion-body">
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 mb-2">
                    ...
                    {{-- <input type="text" class="form-control basic-datepicker" name="wife_dob"> --}}
                </div>
                ...
                <div class="col-lg-3 col-md-6 mb-2">
                    ...
                    {{-- <input type="text" class="form-control basic-datepicker" name="wife_marriage_date"> --}}
                </div>
                ...
                <div class="col-lg-3 col-md-6 mb-2">
                    ...
                    {{-- <input type="text" class="form-control basic-datepicker" name="wife_death_date"> --}}
                </div>

                <div class="col-lg-3 col-md-6 mb-2">
                    <label for="validationDefault01" class="form-label">Phone No.</label>
                    <div class="input-group">
                        <input type="hidden" name="wife_phonecode" value="{{ old('wife_phonecode') ?? '+91' }}">
                        <span class="input-group-text" id="wife_phonecode">+91</span>
                        <input type="text" class="form-control" value="{{ old('wife_phone') }}" name="wife_phone" maxlength="10" oninput="this.value = this.value.replace(/[^0-9]/g, '')">
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 mb-2">
