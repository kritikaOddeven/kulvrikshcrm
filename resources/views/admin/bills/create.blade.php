...
@section('pagetitle', 'Create Bill | Kulvriksh')
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card shadow-sm">
                <form action="{{ url('admin/bills/store') }}" method="post">
                    @csrf
                            ...
                            <div class="col-lg-4 col-md-6 mb-2">
                                ...
                                <div class="position-relative">
                                    <input type="text" class="form-control  pe-5"
                                           name="created_at" id="created_at" value="{{ old('created_at', now()->format('d-m-Y')) }}"
                        ...
                        <div class="row mb-3">
                            <div class="col-lg-4 col-md-6 mb-2">
                                ...
                                <select class="form-select" name="type">
                                    <option value="tax_invoice" {{ old('type')==='tax_invoice'?'selected':'' }}>Tax Invoice</option>
                                    <option value="proformance_invoice" {{ old('type')==='proformance_invoice'?'selected':'' }}>Proformance Invoice</option>
                            ...
                            <div class="col-lg-4 col-md-6 mb-2">
                                ...
                                <input type="text" class="form-control" name="payment_terms"
                                       value="{{ old('payment_terms') }}" placeholder="Enter payment terms">
                            </div>
                            <div class="col-lg-4 col-md-6 mb-2">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="address" id="address_notes"
                                       value="{{ old('address') }}" placeholder="Enter address / notes">
                            </div>
                            <div class="col-md-6">
                    ...
                    <div class="card-footer d-flex justify-content-between">
                        <a href="{{ url('admin/bills') }}" class="btn btn-light">Cancel</a>
...
kulvrikshSearch.addEventListener('input', function () {
    ...
    searchTimer = setTimeout(function () {
        ...
        fetch('{{ url("admin/bills/search-kulvriksh") }}?q=' + encodeURIComponent(query), {
...
document.addEventListener('click', function (e) {
    ...
    function fetchByKulvrikshId(val) {
        ...
        kulvrikshSpinner.style.display = '';
        fetch('{{ url("admin/bills/get-client-by-kulvriksh") }}?kulvrisk_id=' + encodeURIComponent(val), {
            headers: { 'X-Requested-With': 'XMLHttpRequest', 'Accept': 'application/json' }
        })
        .then(r => r.json())
        .then(data => {
    ...
    function fetchByPhone() {
        ...
        fetch('{{ url("admin/bills/get-client-by-phone") }}?phone=' + encodeURIComponent(val), {
            headers: { 'X-Requested-With': 'XMLHttpRequest', 'Accept': 'application/json' }
        })
        .then(r => r.json())
        .then(data => {
...
function fetchByEmail(val) {
    ...
    fetch('{{ url("admin/bills/get-client-by-email") }}?email=' + encodeURIComponent(val), {
        headers: { 'X-Requested-With': 'XMLHttpRequest', 'Accept': 'application/json' }
    })
    .then(r => r.json())
    .then(data => {
