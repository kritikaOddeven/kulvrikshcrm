...
@section('pagetitle','Today-Death | Kulvriksh')
...
<style>
    ...
    <div class="row py-3 align-items-sm-center justify-content-between gap-2">
        <div class="col-auto">
            <h4 class="page-title">Today's Death Anniversaries</h4>
            <ol class="breadcrumb m-0 py-0">
                <li class="breadcrumb-item"><a href="javascript: void(0);">WhatsApp</a></li>
                <li class="breadcrumb-item active">Today's Death Anniversaries</li>
            </ol>
        </div>
        <div class="col-auto">
            <div class="d-flex justify-content-end align-items-center gap-2">
                @can('send_death_whatsapp')
