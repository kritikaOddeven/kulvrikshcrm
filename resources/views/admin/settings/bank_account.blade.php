...
@section('pagetitle','Bank Accounts | Kulvriksh')
@section('admin-content')
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex gap-2">
                                            @can('edit_account')
                                            <a data-value="{{ $item->id }}" class="edit-icon-btn btn-sm btn-action mr-1 editbtn" data-bs-toggle="modal" data-bs-target="#editBankAccount" data-bs-toggle="tooltip" title="edit"><i class="ri-edit-line"></i></a>
                                            @endcan
                                            @can('delete_account')
                                            <form action="{{ url('admin/settings/accounts/' . $item->id) }}" method="POST" id="deleteForm_{{ $item->id }}" style="display:inline;">
                                                @csrf
                                                @method('DELETE')
                                                <button type="button" class="delete-icon-btn btn-sm btn-action mr-1" data-bs-toggle="tooltip" title="delete" data-title="Delete Bank Account" data-description="Are you sure you want to delete this Bank ?" onclick="deleteAccount(this, {{ $item->id }})">
    ...
    @include('admin.settings.partials.add-edit_account_modal')
...
<script>
    ...
    $('.editbtn').on('click', function() {
        ...
        const editUrl = "{{ url('admin/settings/accounts') }}/" + id;
