                                                                                                        ...
                                                                                                        <tbody>
                                                                                                            <tr>
                                                                                                                <td style="width: 180px">
                                                                                                                    <img alt="LogoIpsum" src="{{ asset('assets/admin/images/logo.png') }}" style="border: 0; display: block; outline: none;text-decoration: none; height: auto; width: 100%; font-size: 13px;" width="180" height="auto" />
                                                                                                                </td>
                                                                                                            </tr>
                                                                                                        </tbody>
                                                                                                    </table>
