<div class="modal fade" id="{{ $id ?? 'filterModal' }}" tabindex="-1" aria-labelledby="filterModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="filterModalLabel">{{ $title ?? 'Filter Data' }}</h5>
                ...
                <form method="GET" action="{{ $action ?? url()->current() }}">
                    <div class="row">
                        ...
                        <div class="col-md-12 mt-3 d-flex justify-content-between">
                            <a href="{{ url()->current() }}" type="button" class="btn btn-secondary me-2">Clear</a>
